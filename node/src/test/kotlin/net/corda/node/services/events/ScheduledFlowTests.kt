...
class ScheduledFlowTests {
    ...
    fun setup() {
        ...
        notaryNode = mockNet.createNotaryNode(MockNodeParameters(legalName = DUMMY_NOTARY.name))
        val unstartedAlice = mockNet.createUnstartedNode(MockNodeParameters(legalName = ALICE_NAME))
        val unstartedBob = mockNet.createUnstartedNode(MockNodeParameters(legalName = BOB_NAME))
